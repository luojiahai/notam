 ...
 *
 * A covering surface with no keyboard exit is a trap, so both the panel and
 * the dialog want this. But they nest: the re-analyse confirmation opens on top
 * of an entry panel, and two independent `document` listeners would both fire
 ...
 * registration order would have given exactly the wrong answer: the panel
